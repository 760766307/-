...
- (void)awakeFromNib {
    ...
    _typeLabel.layer.borderColor = [UIColor colorWithRed:0.66f green:0.06f blue:0.11f alpha:1.00f].CGColor;
    _typeLabel.layer.masksToBounds = 1;
    _typeLabel.textColor = [UIColor colorWithRed:0.66f green:0.06f blue:0.11f alpha:1.00f];
    _typeLabel.text = @"新订单";
