...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JJDingdan3Cell *cell = [tableView dequeueReusableCellWithIdentifier:@"JJDingdan3Cell"];
    if (!cell) {
        cell = [[NSBundle mainBundle] loadNibNamed:@"JJDingdan3Cell" owner:self options:nil][0];
    }
